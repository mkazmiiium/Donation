    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-12 col-sm-12 col-form">
                ...
                <h2 class="title-style-2">Donor Registration<span class="title-under"></span></h2>
                ...
                <form action="donor-list">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            <input type="text" name="ic" class="form-control" placeholder="Donor IC Number*" required>
                        </div>

                         <div class="form-group col-md-6">
                            <input type="text" name="name" class="form-control" placeholder="Donor Full Name*" required>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            <input type="text" name="tel-no" class="form-control" placeholder="Donor Telephone No*" required>
                        </div>

                         <div class="form-group col-md-6">
                            <input type="text" name="email" class="form-control" placeholder="Donor E-mail Address*" required>
                        </div>

                    </div>

                    <div class="form-group">
                        <textarea name="address" rows="5" class="form-control" placeholder="Donor Current Address*" required></textarea>
                    </div>

                    <div class="form-group">
                        <textarea name="additional-notes" rows="5" class="form-control" placeholder="Donor Additional Notes"></textarea>
                    </div>
