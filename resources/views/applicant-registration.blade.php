    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-12 col-sm-12 col-form">
                ...
                <h2 class="title-style-2">Applicant Registration<span class="title-under"></span></h2>

                <form action="applicant-list">

                    <div class="row">

                        <div class="form-group col-md-6">
                            <input type="text" name="ic" class="form-control" placeholder="Applicant IC Number*" required>
                        </div>

                         <div class="form-group col-md-6">
                            <input type="text" name="name" class="form-control" placeholder="Applicant Full Name*" required>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            <input type="text" name="tel-no" class="form-control" placeholder="Applicant Telephone No*" required>
                        </div>

                         <div class="form-group col-md-6">
                            <input type="text" name="email" class="form-control" placeholder="Applicant E-mail Address*" required>
                        </div>

                    </div>

                    <div class="form-group">
                        <textarea name="address" rows="5" class="form-control" placeholder="Applicant Current Address*" required></textarea>
                    </div>

                    <div class="form-group">
                        <textarea name="additional-notes" rows="5" class="form-control" placeholder="Applicant Additional Notes"></textarea>
                    </div>
