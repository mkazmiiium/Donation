...
<div class="page-heading text-center">
    ...
    <div class="container zoomIn animated">
        <h1 class="page-title">BASIC NEEDS TO DONATE<span class="title-under"></span></h1>
    </div>
    ...
    <div class="container">
        ...
        <div class="row ">
            ...
            <div class="col-md-12 fadeIn animate-onscroll">
                ...
                <h2 class="title-style-2">List of Basic Needs to Donate<span class="title-under"></span></h2>
                    ...
                    <table class="table table-style-1">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>5kg</td>
                          <td>13</td>
                          <td><input type="textbox" aria-label="Checkbox for following text input" size="3"> x qty</td>
                        </tr>
                        <tr>
                          <th scope="row">2</th>
                          <td>Sugar</td>
                    ...
                    <div>
                        <button type="button" class="btn btn-primary pull-right">Donate</button>
                    </div>
            </div>
