...
<div class="page-heading text-center">
    ...
    <div class="container zoomIn animated">
        <h1 class="page-title">LIST OF FAQIR<span class="title-under"></span></h1>
    </div>
    ...
    <div class="container">
        ...
        <div class="row ">
            ...
            <div class="col-md-12 fadeIn animate-onscroll">
                ...
                <h2 class="title-style-2">List of Faqir <span class="title-under"></span></h2>
                    ...
                    <table class="table table-style-1">
                      ...
                      <tbody>
                        <tr>
                          <th scope="row">1</th>
                          <td>740210065983</td>
                          <td>Mat Kasim bin Karim</td>
                          <td>0129453269</td>
                          <td>m.kasim@gmail.com</td>
                          <td>Puchong Perdana, Selangor</td>
                          <td>NA</td>
                        </tr>
                        <tr>
                          <th scope="row">2</th>
                          <td>724206659983</td>
                          <td>Mazlan bin Lazim</td>
                          <td>0141256493</td>
                          <td>mazlan@gmail.com</td>
                          <td>Taman Baginda Nusa, Kepong, Selangor</td>
                          <td>NA</td>
                        </tr>
                        <tr>
                          <th scope="row">3</th>
                          <td>650816423598</td>
                          <td>Razarudin bin Hassan</td>
                          <td>0134521698</td>
                          <td>raza@gmail.com</td>
                          <td>Taman Botanik Rimba, Klang, Selangor</td>
                          <td>NA</td>
                        </tr>
                        <tr>
                            <th scope="row">4</th>
                            <td>640331595215</td>
                            <td>Abdul Jalil bin Hassan</td>
                            <td>0147889126</td>
                            <td>jalil@gmail.com</td>
                            <td>Precint 1, Wilayah Persekutuan, Putrajaya</td>
                            <td>NA</td>
                          </tr>
                          <tr>
                            <th scope="row">5</th>
                            <td>720312504986</td>
                            <td>Omar bin Haji Mammah</td>
                            <td>0129546218</td>
                            <td>omar@gmail.com</td>
                            <td>Subang Permai, Shah Alam, Selangor</td>
                            <td>NA</td>
                          </tr>
                      </tbody>
                    </table>
