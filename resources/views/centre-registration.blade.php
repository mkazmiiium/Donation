    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-12 col-sm-12 col-form">
                ...
                <h2 class="title-style-2">Distribution Centre Registration<span class="title-under"></span></h2>

                <form action="centre-list">

                    <div class="row">

                        <div class="form-group col-md-6">
                            <input type="text" name="name" class="form-control" placeholder="Centre Name*" required>
                        </div>

                         <div class="form-group col-md-6">
                            <input type="text" name="tel-no" class="form-control" placeholder="Centre Telephone No*" required>
                        </div>

                    </div>

                    <div class="form-group">
                        <textarea name="address" rows="5" class="form-control" placeholder="Centre Address*" required></textarea>
                    </div>
